...
class Upload extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('file_name, user_file_name, ext', 'required'),
			array('file_name, user_file_name, ext', 'length', 'max'=>255),
			array('created', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, file_name, user_file_name, ext, created', 'safe', 'on'=>'search'),
		);
	}

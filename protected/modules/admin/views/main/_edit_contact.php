        ...
        <div class="modal-body">
            <form id="form-save-model" action="/admin/main/contact" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select id="model-default_in_city" name="Contact[default_in_city]"
                            data-value="{{>item.default_in_city}}">
                        <option value="0">нет</option>
                        <option value="1">да</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="Contact[longitude]" class="contact_longitude"
